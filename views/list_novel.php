                ...
                <ul class="navbar-nav ml-auto pr-3">
                    ...
                    <li class="nav-item dropdown pr-3">
                        ...
                        <div class="dropdown-menu dropdown-menu-right item" aria-labelledby="navbarDropdown">
                            ...
                            <a class="dropdown-item" href="#">Hot picks</a>
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item" href="#">New entries</a>
                        </div>
                    </li>
                </ul>
                    ...
                    <div class="col-md-9 col-12">
                        ...
                        <div class="row table-pagination pr-md-5 px-3 pl-md-0">
                            <table class="table table-striped danhsach">
                                ...
                                <tbody>
                                    <tr>
                                        <td><a class="alink" href="novel_info.html">Dungeon Defense</a></td>
                                        <td>Chapter 8</td>
                                        <td>31/12/2017</td>
                                    ...
                                    <tr>
                                        <td>Release That Witch</td>
                                        <td>Chapter 10</td>
                                        <td>31/12/2017</td>
                                        <td class="text-center">0</td>
                                    </tr>
                                    <tr>
                                        <td>I've Been Reincarnated!</td>
                                        <td>Chapter 10</td>
                                        <td>31/12/2017</td>
                                        <td class="text-center">0</td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td>Angel Beats! Track Zero</td>
                                        <td>Chapter 10</td>
                                        <td>31/12/2017</td>
                                        <td class="text-center">0</td>
                                    </tr>
                                    <tr>
                                        <td>Goblin Kingdom</td>
                                        <td>Chapter 10</td>
                                        <td>31/12/2017</td>
                                        <td class="text-center">0</td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td>Magi's Grandson</td>
                                        <td>Chapter 10</td>
                                        <td>31/12/2017</td>
                                        <td class="text-center">0</td>
                                    </tr>
                                    <tr>
                                        <td>Parasite in Love</td>
                                        <td>Chapter 10</td>
                                        <td>31/12/2017</td>
                                        <td class="text-center">0</td>
                                    </tr>
