                ...
                <div class="row m-0">
                    ...
                    <div class="new-story__block new-story__right col-md-9 description">
                        <h3 class="text-center">
                            <a href="/enovel//enovel/views/novel_info.php">Dungeon Defense</a>
                        </h3>
                ...
                <div class="row">
                    <div class="col-lg col-md-4">
                        <div class="story-list__item mb-4">
                            ...
                            <div class="story-list__name">
                                <a href="/enovel//enovel/views/novel_info.php">Pursuing Immortality</a>
                                <p>Chapter 330</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg col-md-4">
                        <div class="story-list__item mb-4">
                            ...
                            <div class="story-list__name">
                                <a href="/enovel//enovel/views/novel_info.php">Bungaku Shoujo</a>
                                <p>Chapter 20</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg col-md-4">
                        <div class="story-list__item mb-4">
                            ...
                            <div class="story-list__name">
                                <a href="/enovel//enovel/views/novel_info.php">.hack//Cell</a>
                                <p>Chapter 2018</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg col-md-4">
                        <div class="story-list__item mb-4">
                            ...
                            <div class="story-list__name">
                                <a href="/enovel//enovel/views/novel_info.php">(Um, Sorry) I’ve Been Reincarnated!</a>
                                <p>Chapter 28</p>
                            </div>
                        </div>
                    </div>
